...
//侧边栏出现   side-ce
    ...
    //加入购物车出现
        for(let i=0;i<getClass("he-wrap").length;i++){           	         	
          	getClass("gg")[i].onmouseover=function(){
   	 	        getClass("he-wrap")[i].children[1].style.visibility="visible";
   	        }     
	        getClass("gg")[i].onmouseout=function(){
	   	        getClass("he-wrap")[i].children[1].style.visibility="hidden";
	        }
        }
